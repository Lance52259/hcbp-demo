...
* [最佳实践](best-practices/)
  ...
  * [AAD](best-practices/aad/)
    * [简介](best-practices/aad/index.md)
    * [部署黑白名单](best-practices/aad/black_white_lists.md)
  ...
  * [BCS](best-practices/bcs/)
    * [简介](best-practices/bcs/index.md)
    * [部署基础实例](best-practices/bcs/basic.md)
  ...
  * [CPTS](best-practices/cpts/)
    * [简介](best-practices/cpts/index.md)
    * [部署CPTS项目和测试任务](best-practices/cpts/project_with_task.md)
  * [CSS](best-practices/css/)
    ...
    * [部署Logstash集群](best-practices/css/logstash_cluster.md)
  ...
  * [DataArts](best-practices/dataarts/)
    ...
    * [部署DataArts Security数据识别规则组](best-practices/dataarts/security_data_recognition_rule_group.md)
  ...
  * [DBSS](best-practices/dbss/)
    ...
    * [部署基础实例](best-practices/dbss/basic_instance.md)
  ...
  * [HSS](best-practices/hss/)
    ...
    * [部署配额](best-practices/hss/quota.md)
  ...
  * [ModelArts](best-practices/modelarts/)
    ...
    * [部署实时推理服务](best-practices/modelarts/deploy_real_time_service.md)
  ...
  * [RAM](best-practices/ram/)
    ...
    * [部署细粒度权限管理](best-practices/ram/fine_grained_permission_management.md)
  ...
  * [TMS](best-practices/tms/)
    ...
    * [部署资源类型查询](best-practices/tms/query_resource_types.md)
  ...
  * [VPCEP](best-practices/vpcep/)
    ...
    * [部署审批](best-practices/vpcep/approval.md)
